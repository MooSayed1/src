...
static const char *fonts[]          = { "JetBrains Mono:size=20", "JoyPixels:pixelsize=11:antialias=true:autohint=true"};
...
static const Key keys[] = {
  ...
  /*New Look */
  { MODKEY|ShiftMask,            XK_c,       spawn,           SHCMD("/home/mohamed/.local/bin/newlook") },
  /*Volume Kymaping*/
  ...
  /*Exinting Scrpit*/
  { MODKEY,                      XK_x,       spawn,           SHCMD("~/.local/bin/exiting")},
};
